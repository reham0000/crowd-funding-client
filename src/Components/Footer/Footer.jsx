...
const Footer = () => {
  ...
  const socialLinks = [
    {
      ...
      url: "https://www.youtube.com/@almobinreham4654",
      name: "YouTube",
    },
    {
      icon: <FaFacebook size={20} />,
      url: "https://www.facebook.com/al.mobin.reham.2025",
      name: "Facebook",
    },
    {
      icon: <FaInstagram size={20} />,
      url: "https://www.instagram.com/almobin_reham/",
      name: "Instagram",
    },
  ];
  ...
  const contactInfo = [
    { icon: <FiMail />, text: "support@crowdfunding.com" },
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <motion.div variants={itemVariants} className="space-y-4">
            ...
            <p className="text-gray-600">
              Empowering communities through collective action and sustainable
              funding solutions.
            </p>
          ...
          <motion.div variants={itemVariants} className="space-y-4">
            ...
            <p className="text-gray-600">
              Thank You for visiting our website. Your donation is very helpful
              for us.
            </p>
        ...
        >
          <div className="flex items-center mb-4 md:mb-0">
            ...
            <span>{currentYear} Crowd Funding. All rights reserved.</span>
          </div>
